    ...
    local tt = {
...

        {
            ...
            want_screen_log = {
                ...
                {fn = "setColor", args = {0x36, 0x36, 0x36}},
        ...
        },
        {
            ...
            want_screen_log = {
                ...
                {fn = "setColor", args = {0xFF, 0xFF, 0xFF}},
                {fn = "drawRectF", args = {0, 0, 5, 6}},
                {fn = "setColor", args = {0x07, 0x07, 0x07}},
                {fn = "drawText", args = {0, 0, "A"}},
            },
        },
        {
            ...
            want_screen_log = {
                {fn = "setColor", args = {0x00, 0x00, 0x00}},
                {fn = "drawClear", args = {}},
                {fn = "setColor", args = {0x04, 0x05, 0x06}},
                {fn = "drawRectF", args = {0, 0, 5, 6}},
        ...
        },
        {
            ...
            want_screen_log = {
                {fn = "setColor", args = {0x00, 0x00, 0x00}},
                {fn = "drawClear", args = {}},
                {fn = "setColor", args = {0xFF, 0xA2, 0x72}},
                {fn = "drawRectF", args = {0, 0, 5, 6}},
                {fn = "setColor", args = {0x36, 0x36, 0x36}},
                {fn = "drawText", args = {0, 0, "A"}},
                {fn = "setColor", args = {0x01, 0x02, 0x03}},
...
function test_decl.testAdjustRGB(t)
    local tt = {
        {
            in_col = {0x00, 0x00, 0x00},
            want_col = {0x00, 0x00, 0x00},
        },
        {
            in_col = {0x3F, 0x7F, 0xBF},
            want_col = {0x08, 0x15, 0x32},
        },
        {
            in_col = {0x01, 0xF5, 0xF6},
            want_col = {0x00, 0xEC, 0xFF},
        },
        {
            in_col = {0xFF, 0xFF, 0xFF},
            want_col = {0xFF, 0xFF, 0xFF},
        },
    }
    ...
    for _, tc in ipairs(tt) do
        ...
        local got_col = t.env.adjustRGB(tc.in_col)
        assertEqual("col", tc.want_col, got_col)
    end
end
